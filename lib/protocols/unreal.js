...
UnrealProtocol.prototype.sendNotice = function (bot, target, message)
{
	this.sendRaw(":" + bot._nickname + " NOTICE " + target + " :" + message);
}

UnrealProtocol.prototype.selfQuit = function (reason)
{
	this.sendRaw("SQUIT " + (this._set.serviceHost || "service.node.js") + (reason ? " :" + reason : ""));
}

UnrealProtocol.prototype.botQuit = function (bot, reason)
{
	this.sendRaw(":" + bot._nickname + " QUIT" + (reason ? " :" + reason : ""));
}
